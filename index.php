        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                <li class="menu-has-children"><a href="#">Games</a>
                    <ul>
                        <li><a href="details.php">Dota 2</a></li>
                        <li><a href="details.php">Liên minh huyền thoại</a></li>
                        <li><a href="details.php">Tốc chiến</a></li>
                        <li><a href="details.php">Valorant</a></li>
                        <li><a href="details.php">Đấu trường chân lý</a></li>
                        <li><a href="details.php">Liên quân mobie</a></li>
                        <li><a href="details.php">CS.GO</a></li>
                    </ul>
                </li>
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                            <a href="details.php" class="primary_img">
                                                <img src="images/Lien-Minh-Huyen-Thoai-ky-niem-10-nam-1.png" alt="men">
                                            </a>
                                        </div>
